...
There are two initial biomass quantities that are reported, these are `Bzero` and `Binit`. `Bzero` is the spawning biomass from a population that has been exposed to natural mortality, recruitment (R0), and movement. `Binit` is the spawning biomass from a population that has been exposed to natural mortality and initial fishing mortality, recruitment (R0), and movement. 
