...
For recapture conditioned tag-recovery observations, a recovery event relates a specific year i.e., the number of recoveries at each location within a year. Only the multinomial likelihood is available for this tag-recovery observation.
...
- How to deal with the high number of zeros in \(\boldsymbol{N^k}\)
