...
# Find F-reference based on deterministic recruitment to achieve 40% bzero in each region
region_F_ref = find_regional_fref(proj_obj, proj_pars, percent_Bzero = 40)
