...
test_that("survey-abundance-test", {
  ...
  data$srv_dom_ll_bio_indicator[data$srv_dom_ll_bio_indicator == 0] = 1
  data$srv_dom_ll_obs_is_abundance = 1
  mean_obs_val = 12
  data$obs_srv_dom_ll_bio = array(mean_obs_val, dim = c(data$n_regions, ncol(data$srv_dom_ll_bio_indicator)))
  data$obs_srv_dom_ll_se = array(0.3 * mean_obs_val, dim = c(data$n_regions, ncol(data$srv_dom_ll_bio_indicator)))
  ...
  data$obs_srv_dom_ll_se = array(0.3, dim = c(data$n_regions, ncol(data$srv_dom_ll_bio_indicator)))
  ...
  expect_equal(test_report$nll[5], -1.0 * sum(dlnorm(test_report$obs_srv_dom_ll_bio, log(test_report$pred_srv_dom_ll_bio) - 0.5*test_report$obs_srv_dom_ll_se^2, test_report$obs_srv_dom_ll_se, log = T)), tolerance = 0.001)

  ## nuisance q calculation
  data$q_is_nuisance = 1
