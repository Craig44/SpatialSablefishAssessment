  ...
  for(year_ndx = 0; year_ndx < n_years; ++year_ndx) {
    ...
    if(ll_catchatage_indicator(year_ndx) == 1) {
      ...
      if(ll_catchatage_comp_likelihood == 0) {
        ...
        nll(0) -= dmultinom_upd(vector<Type>(obs_ll_catchatage.col(ll_catchatage_ndx)), vector<Type>(pred_ll_catchatage.col(ll_catchatage_ndx)), true);
      }
      ++ll_catchatage_ndx;
    }
    ...
    if(ll_catchatlgth_indicator(year_ndx) == 1) {
      ...
      if(ll_catchatlgth_comp_likelihood == 0) {
        ...
        nll(15) -= dmultinom_upd(vector<Type>(obs_ll_catchatlgth_m.col(ll_catchatlgth_ndx)), vector<Type>(pred_ll_catchatlgth_m.col(ll_catchatlgth_ndx)), true);
        nll(16) -= dmultinom_upd(vector<Type>(obs_ll_catchatlgth_f.col(ll_catchatlgth_ndx)), vector<Type>(pred_ll_catchatlgth_f.col(ll_catchatlgth_ndx)), true);
      }
      ++ll_catchatlgth_ndx;
    }
    ...
    if(trwl_catchatlgth_indicator(year_ndx) == 1) {
      ...
      if(trwl_catchatlgth_comp_likelihood == 0) {
        ...
        nll(1) -= dmultinom_upd(vector<Type>(obs_trwl_catchatlgth_m.col(trwl_catchatlgth_ndx)), vector<Type>(pred_trwl_catchatlgth_m.col(trwl_catchatlgth_ndx)), true);
        nll(2) -= dmultinom_upd(vector<Type>(obs_trwl_catchatlgth_f.col(trwl_catchatlgth_ndx)), vector<Type>(pred_trwl_catchatlgth_f.col(trwl_catchatlgth_ndx)), true);
      }
    ...
    if(srv_dom_ll_age_indicator(year_ndx) == 1) {
      ...
      if(srv_dom_ll_age_comp_likelihood == 0) {
        ...
        nll(6) -= dmultinom_upd(vector<Type>(obs_srv_dom_ll_age.col(srv_dom_ll_age_ndx)), vector<Type>(pred_srv_dom_ll_age.col(srv_dom_ll_age_ndx)), true);
      }
    ...
    if(srv_dom_ll_lgth_indicator(year_ndx) == 1) {
      ...
      if(srv_dom_ll_lgth_comp_likelihood == 0) {
        ...
        nll(7) -= dmultinom_upd(vector<Type>(obs_srv_dom_ll_lgth_m.col(srv_dom_ll_lgth_ndx)), vector<Type>(pred_srv_dom_ll_lgth_m.col(srv_dom_ll_lgth_ndx)), true);
        nll(8) -= dmultinom_upd(vector<Type>(obs_srv_dom_ll_lgth_f.col(srv_dom_ll_lgth_ndx)), vector<Type>(pred_srv_dom_ll_lgth_f.col(srv_dom_ll_lgth_ndx)), true);
      }
      ++srv_dom_ll_lgth_ndx;
    }
    ...
    if(srv_jap_ll_age_indicator(year_ndx) == 1) {
      ...
      if(srv_jap_ll_age_comp_likelihood == 0) {
        ...
        nll(9) -= dmultinom_upd(vector<Type>(obs_srv_jap_ll_age.col(srv_jap_ll_age_ndx)), vector<Type>(pred_srv_jap_ll_age.col(srv_jap_ll_age_ndx)), true);
      }
    ...
    if(srv_jap_ll_lgth_indicator(year_ndx) == 1) {
      ...
      if(srv_jap_ll_lgth_comp_likelihood == 0) {
        ...
        nll(10) -= dmultinom_upd(vector<Type>(obs_srv_jap_ll_lgth_m.col(srv_jap_ll_lgth_ndx)), vector<Type>(pred_srv_jap_ll_lgth_m.col(srv_jap_ll_lgth_ndx)), true);
        nll(11) -= dmultinom_upd(vector<Type>(obs_srv_jap_ll_lgth_f.col(srv_jap_ll_lgth_ndx)), vector<Type>(pred_srv_jap_ll_lgth_f.col(srv_jap_ll_lgth_ndx)), true);
      }
      ++srv_jap_ll_lgth_ndx;
    }
    ...
    if(srv_nmfs_trwl_age_indicator(year_ndx) == 1) {
      ...
      if(srv_nmfs_trwl_age_comp_likelihood == 0) {
        ...
        nll(12) -= dmultinom_upd(vector<Type>(obs_srv_nmfs_trwl_age.col(srv_nmfs_trwl_age_ndx)), vector<Type>(pred_srv_nmfs_trwl_age.col(srv_nmfs_trwl_age_ndx)), true);
      }
    ...
    if(srv_nmfs_trwl_lgth_indicator(year_ndx) == 1) {
      ...
      if(srv_nmfs_trwl_lgth_comp_likelihood == 0) {
        ...
        nll(13) -= dmultinom_upd(vector<Type>(obs_srv_nmfs_trwl_lgth_m.col(srv_nmfs_trwl_lgth_ndx)), vector<Type>(pred_srv_nmfs_trwl_lgth_m.col(srv_nmfs_trwl_lgth_ndx)), true);
        nll(14) -= dmultinom_upd(vector<Type>(obs_srv_nmfs_trwl_lgth_f.col(srv_nmfs_trwl_lgth_ndx)), vector<Type>(pred_srv_nmfs_trwl_lgth_f.col(srv_nmfs_trwl_lgth_ndx)), true);
      }
    ...
    // Survey for the Japanese longline fisheryLength frequency
    if(srv_jap_fishery_ll_lgth_indicator(year_ndx) == 1) {
      ...
      if(srv_jap_fishery_ll_lgth_comp_likelihood == 0) {
        ...
        nll(19) -= dmultinom_upd(vector<Type>(obs_srv_jap_fishery_ll_lgth.col(srv_jap_fishery_ll_lgth_ndx)), vector<Type>(pred_srv_jap_fishery_ll_lgth.col(srv_jap_fishery_ll_lgth_ndx)), true);
      }
